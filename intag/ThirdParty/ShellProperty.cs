    ...
    public class ShellProperty<T> : IShellProperty
    {
            ...
            set
            {
                ...
                if (typeof(T) != ValueType)
                {
                    throw new NotSupportedException(
                        ...
                        "This property only accepts a value of type \"{0}\".", ValueType.Name));
                }
        ...
        private void StorePropVariantValue(PropVariant propVar)
        {
            ...
            try
            {
                ...
                if (!CoreErrorHelper.Succeeded(hr))
                {
                    throw new PropertySystemException("Unable to get writable property store for this property.",
                ...
                {
                    throw new PropertySystemException("Unable to set property.", Marshal.GetExceptionForHR((int)result));
                }
            ...
            {
                throw new PropertySystemException("Unable to get writable property store for this property.", e);
            }
