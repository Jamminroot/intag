    ...
    internal static class FolderTypes
    {
        ...
        static FolderTypes()
        {
            types = new Dictionary<Guid, string>
            {
                ...
                { Contacts, "Contacts" },
                { ControlPanelCategory, "ControlPanel Category" },
                { ControlPanelClassic, "ControlPanel Classic" },
                { Documents, "Documents" },
                { Games, "Games" },
                { GenericSearchResults, "Generic SearchResults" },
                { GenericLibrary, "Generic Library" },
                ...
                { SoftwareExplorer, "Software Explorer" },
