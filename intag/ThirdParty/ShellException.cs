...
namespace intag.ThirdParty
{
    ...
    public class ShellException : ExternalException
    {
        ...
        public ShellException(int errorCode) : base("Shell Exception has occurred, look at inner exception for information.", errorCode)
        {
        }
        ...
        protected ShellException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context) : base(info, context)
        {
        }
    }
}